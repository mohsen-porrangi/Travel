...
public class IntegratedPurchaseInternalEndpoints : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        // Endpoint برای آغاز فرآیند خرید یکپارچه
        app.MapPost("api/internal/payments/integrated", async (
        ...
        app.MapPost("api/internal/payments/integrated/execute", async (
