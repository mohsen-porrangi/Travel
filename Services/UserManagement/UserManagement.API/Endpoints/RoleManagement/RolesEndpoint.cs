// فایل: Services/UserManagement/UserManagement.API/Endpoints/RoleManagement/RolesEndpoint.cs
using UserManagement.API.Endpoints.AccessControl.Permissions;
using UserManagement.API.Endpoints.RoleManagement.Role.CreateRole;
using UserManagement.API.Endpoints.RoleManagement.Role.DeleteRole;
using UserManagement.API.Endpoints.RoleManagement.Role.GetAllRoles;
using UserManagement.API.Endpoints.RoleManagement.Role.UpdateRole;
